...
3. [Schema Creation](#schema-creation)
   - [Schema Creation Script (`schema.sql`)](#schema-creation-script-01-schemasql)
4. [Data Loading](#data-loading)
   - [Data Loading Script (`load_data.sql`)](#data-loading-script-02-load_datasql)
5. [Materialized View](#materialized-view)
   - [Materialized View Creation Script (`materialized-view.sql`)](#materialized-view-creation-script-03-materialized-viewsql)
